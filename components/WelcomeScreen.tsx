...
import { UploadCloudIcon, FileTextIcon, ClockIcon } from './icons';
                 ...
                 >
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        종합 점수: <span className="font-bold text-slate-800">{item.totalScore.toFixed(1)}</span> / 10
                      </p>
                    </div>
                    <div className="text-sm text-slate-400 group-hover:text-primary">
                      상세보기 →
                    </div>
                 </button>
               ))}
